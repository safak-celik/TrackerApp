...
class SleepQualityFragment : Fragment() {
    ...
    private lateinit var arguments: SleepQualityFragmentArgs
    ...
    override fun onCreateView(
        ...
        arguments = SleepQualityFragmentArgs.fromBundle(requireArguments())
        // Create an instance of the ViewModel Factory.
        dataSource = SleepDatabase.getInstance(application).sleepDatabaseDao
        sleepQualityViewModelFactory = SleepQualityViewModelFactory(arguments.sleepNightKey, dataSource)

        // Get a reference to the ViewModel associated with this fragment.
        val sleepQualityViewModel =
            ViewModelProvider(
                this, sleepQualityViewModelFactory
